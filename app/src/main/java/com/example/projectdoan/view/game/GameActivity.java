package com.example.projectdoan.view.game;
...
import com.example.projectdoan.model.IDButton;
import com.example.projectdoan.model.Question;
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case CHECK_ANWSER:
                        if (checkAnwser()) {
                            Toast.makeText(GameActivity.this, "Bạn Đúng Là Thiên Tài !", Toast.LENGTH_SHORT).show();
                            point += 100;

                            SharedPrefUtils.saveData(GameActivity.this, KEY_POINT, point);
                            ...
                            Toast.makeText(GameActivity.this, "Đáp án sai !", Toast.LENGTH_SHORT).show();
